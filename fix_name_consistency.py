...
RULES = [
    # --- Baofu ---
    (re.compile(r'传闻屋鲍芙'), '传闻屋Baofu'),
    (re.compile(r'鲍芙'),   'Baofu'),
    (re.compile(r'传闻贩子帕奥夫'), '传闻屋Baofu'),
    (re.compile(r'鲍芙 '),   'Baofu'),
    (re.compile(r'帕乌夫'),         'Baofu'),
    (re.compile(r'帕奥夫'),         'Baofu'),
    ...
    (re.compile(r'影人类类'),   '影人类'),
   # (re.compile(r'影人'),   '影人类'),
   # (re.compile(r'影子人'),   '影人类'),
   # re.compile(r'阴影人'),   '影人类'),
    # # 影達の宴 -> 影子舞会
    ...
    # # 若い女/若い男 -> 年轻女人/年轻男人
    (re.compile(r'年轻女性'), '年轻女人'),
    (re.compile(r'年轻男子'), '年轻男人'),
    # # 口裂け女/クチサケ -> 裂口女
     (re.compile(r'口裂'), '裂口女'),
      (re.compile(r'库奇萨克'), '裂口女'),
      (re.compile(r'库奇萨凯'), '裂口女'),
    # # ジャンピングじじい -> 蹦跶老头
    (re.compile(r'跳跃爷爷'), '蹦跶老头'),
    (re.compile(r'跳跳老头'), '蹦跶老头'),
    (re.compile(r'跳跃老头'), '蹦跶老头'),
    (re.compile(r'跳跃老爷爷'), '蹦跶老头'),
    # # クダン -> 件
    ...
    (re.compile(r'狮子国王'), '狮子座国王'),
    # (re.compile(r'シャドウ'), '阴影'),
    # (re.compile(r'シャドウ'), '阴影'),
    # (re.compile(r'雪乃'), '雪野'),
    (re.compile(r'Ischikick'), '伊修奇克'),
    (re.compile(r'伊修基克'), '伊修奇克'),
    # (re.compile(r'伊迪尔先生'), '理想老师'),
    (re.compile(r'Toro'), '托罗'), 
    (re.compile(r'トロ'), '托罗'),
    (re.compile(r'银古'), '银子'),
    (re.compile(r'偶像迷'), '发烧友'),
    (re.compile(r'阿萨奇'), '小朝'),
    (re.compile(r'七姐妹学园男生'), '七姐妹学园男学生'),
    (re.compile(r'沧桑大叔'), '沉稳大叔')
]
